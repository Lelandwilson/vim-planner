...
function M.apply_defaults()
  ...
  map('n', P('o'), function() require('smartplanner.ui.help').toggle() end, 'SmartPlanner: Show/hide help overlay')
  -- Deltas
  ...
  map('n', P('i'), function() require('smartplanner.views.planner').rename_current() end, 'SmartPlanner: Rename current label')
  -- Delta instance quick edit (on delta lines)
  map('n', P('+'), function() require('smartplanner.views.planner').delta_increment(1) end, 'SmartPlanner: Increase delta (step)')
  map('n', P('-'), function() require('smartplanner.views.planner').delta_increment(-1) end, 'SmartPlanner: Decrease delta (step)')
  map('n', P('='), function() require('smartplanner.views.planner').delta_set() end, 'SmartPlanner: Set delta (hours)')
