...
function M.apply_defaults()
  ...
  map('n', '<leader>scm', function() require('smartplanner').open_calendar({ view = 'month' }) end, 'SmartPlanner: Calendar Month')
  map('n', '<leader>scw', function() require('smartplanner').open_calendar({ view = 'week' }) end, 'SmartPlanner: Calendar Week')
  map('n', '<leader>scd', function() require('smartplanner').open_calendar({ view = 'day' }) end, 'SmartPlanner: Calendar Day')
